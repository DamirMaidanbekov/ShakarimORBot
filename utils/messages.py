...
MESSAGES = {
    "ru": {
        ...
        "question_accepted": "✅ Ваш вопрос #{} принят! Ожидайте ответа от сотрудников Офиса Регистратора Шәкәрім Университет. ⏳",
        ...
        # Дополнительные сообщения регистрации
        "enter_course": "🎓 Пожалуйста, введите Ваш курс (от 1 до 4):",
        "enter_faculty": "🏫 Пожалуйста, введите Ваш факультет:",
        "enter_department": "🔬 Пожалуйста, введите Вашу кафедру:",
        "enter_group": "👥 Пожалуйста, введите Вашу группу (например, ПИз-200):",
        "invalid_course": "⚠️ Пожалуйста, введите корректный курс (число от 1 до 4).",
        "invalid_faculty": "⚠️ Пожалуйста, введите корректный факультет.",
        "invalid_department": "⚠️ Пожалуйста, введите корректную кафедру.",
        "invalid_group": "⚠️ Пожалуйста, введите корректную группу.",
    },
    ...
    "kz": {
        ...
        # Дополнительные сообщения регистрации
        "enter_course": "🎓 Курсыңызды енгізіңіз (1-ден 4-ке дейін):",
        "enter_faculty": "🏫 Факультетіңізді енгізіңіз:",
        "enter_department": "🔬 Кафедраңызды енгізіңіз:",
        "enter_group": "👥 Топыңызды енгізіңіз (мысалы, ПИз-200):",
        "invalid_course": "⚠️ Дұрыс курсты енгізіңіз (1-ден 4-ке дейінгі сан).",
        "invalid_faculty": "⚠️ Дұрыс факультетті енгізіңіз.",
        "invalid_department": "⚠️ Дұрыс кафедраны енгізіңіз.",
        "invalid_group": "⚠️ Дұрыс топты енгізіңіз.",
    },
    ...
    "en": {
        ...
        # Дополнительные сообщения регистрации
        "enter_course": "🎓 Please enter your course (from 1 to 4):",
        "enter_faculty": "🏫 Please enter your faculty:",
        "enter_department": "🔬 Please enter your department:",
        "enter_group": "👥 Please enter your group (for example, CS-200):",
        "invalid_course": "⚠️ Please enter a valid course (number from 1 to 4).",
        "invalid_faculty": "⚠️ Please enter a valid faculty.",
        "invalid_department": "⚠️ Please enter a valid department.",
        "invalid_group": "⚠️ Please enter a valid group.",
    }
}
